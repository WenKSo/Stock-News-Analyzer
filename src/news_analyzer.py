...
def categorize_news_by_industry(news_text):
    ...
    一、科技与创新类
    1. 人工智能（AI）
       细分方向：机器学习、计算机视觉、自然语言处理（NLP）、AI算力、AIGC（生成式AI）
    2. 半导体/芯片
       细分方向：集成电路设计、晶圆制造、封测、EDA工具、先进封装
    3. 5G通信
       细分方向：基站设备、光模块、射频器件、卫星通信
    4. 云计算/大数据
       细分方向：数据中心（IDC）、SaaS、边缘计算、数据湖
    5. 元宇宙/虚拟现实（VR/AR）
       细分方向：VR设备、数字孪生、NFT、虚拟社交
    6. 区块链/数字货币
       细分方向：数字人民币、加密技术、金融科技
    7. 量子科技
       细分方向：量子计算、量子通信、量子密钥分发

    二、新能源与绿色经济类
    1. 新能源汽车
       细分方向：锂电池、氢能源、充电桩、固态电池
    2. 光伏（太阳能）
       细分方向：HJT电池、钙钛矿、逆变器、光伏玻璃
    3. 风电
       细分方向：陆上风电、海上风电、叶片材料
    4. 储能
    ...
    六、2025年最新热点主题
    1. AI+（人工智能深化应用）
       细分方向：国产算力、AI+办公、AI+工业、端侧AI
    2. 智慧交通
       细分方向：智能驾驶、低空经济、商业航天
    3. 人形机器人
       细分方向：整机厂商、上游零部件（电控、机械、传感）
    4. 悦己经济
       细分方向：情绪消费、美妆、旅游
    5. 首发经济
       细分方向：零售转型、潮玩与IP经济
    6. 生物制造
       细分方向：合成生物学、生物化工、生物制药
    7. 未来能源
       细分方向：固态电池、钙钛矿、氢能
    8. 中美博弈
       细分方向：自主可控、贸易摩擦、出海发展
    ...
    主要行业类别：[选择最匹配的行业大类，如"科技与创新类"、"新能源与绿色经济类"等]
    细分领域：[选择最匹配的细分领域，如"人工智能"、"新能源汽车"等]
